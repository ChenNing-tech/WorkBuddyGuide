---
title: 提示词库
description: 12 个常用提示词模板，覆盖问清问题、学习、解决问题、决策与认识自己五大场景，复制后替换【】内容即可使用。
---

# 12 个常用提示词

它们主要分成 5 个场景：问清问题、学习、解决问题、决策，还有认识自己。

全部可以单独复制使用，也都不需要安装任何 Skill，适配如今你能用到的所有 AI。

所有的提示词都做成了模板，用的时候，把【】里的内容，都换成你自己的信息。

同时，如果你本身就有一些原始材料比如文档啥的，就尽量也扔上去，这年头，不怕上下文多。

## 一、问清问题

问问题可能是这个世界上，跟 AI 交互最基础的一环。

这一部分，专门帮你理清楚你的问题，只有知道自己真正想问的是什么，才有后面的一切。

底层本质上，非常推荐大家去读一下尼尔·布朗的经典书籍《学会提问》。

### 1. 苏格拉底式提问

人类有的时候，确实会比较混乱，经常嘴上问的和心里真正想表达的，其实不是一个意思。

苏格拉底式提问，就是通过追问，帮你把问题想得更清楚，同时补上 AI 更加需要的上下文。
...
这个 Prompt，可以帮你解决“我究竟想问的本质问题是什么”。问题问清楚了，整个流程，才能继续。

## 二、学习

面对一个陌生的东西，我们经常会有几种需求，对应四种不同的方法：

- “这个概念我完全听不懂”，可以用双层解释法；
- “这个成品做得真厉害，我想模仿学习它”，可以用反向拆解；
- “我想深度、系统地研究某个东西”，可以用横纵分析法；
- “这份资料里的说法到底是真的吗？”，可以用事实核查。

### 2. 双层解释法

很多人喜欢跟 AI 说“请把我当成小学生解释”。确实容易听懂，但也很容易停留在“好像懂了”的阶段：类比记住了，真正的机制还是一团雾。

更好的方式是让它分别从小白和专家的角度各解释一遍，这样可以帮助我更好地学习。
...
很好用，Vibe Coding 的时候经常遇到一些看不懂的数据库、网络安全之类的名词，就是一边双层解释一边学习的。

### 3. 反向拆解

有时候，你看到一个很好的作品或者网站，想学习它到底好在哪，就可以用这个反向拆解。
...
能快速地帮你调研和拆解原作品，然后获得一些收获。

### 4. 横纵分析法

一个非常经典的分析市场里公司和新概念的框架，详情可看：[分享一个我用了2年的深度研究Prompt，半小时帮你搞懂任何陌生领域。](https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA==&mid=2647681493&idx=1&sn=76f444ffcb134e6e8763d03fe03ae5ca&scene=21#wechat_redirect)

它的核心只有两条轴：纵轴看一个东西怎么走到今天的，横轴看它今天跟一众竞品比到底有啥区别。两条轴交叉起来，才能看见历史上的选择，以及是怎么演化到今天这样的。

一定要配合各个 AI 产品的深度研究功能来用，效果才是满血版。
...
大家也都知道，AI 经常出幻觉，虽然现在少了很多，但是还是有。而且人类的幻觉，现在往往比 AI 还要大。

所以很多时候，无论是人类还是 AI 的内容，我们都要尽可能怀疑一切。于是就有了这个事实核查的 Prompt。
...
如何问问题、如何学习，都清楚了。那现在，要解决问题了。这里列三块：专家会诊、第一性原理、跨领域借解。

### 6. 专家会诊

以前很流行在 Prompt 开头写一句“你是一位拥有20年经验的世界级专家”。但是很多问题，其实是属于多个专家互相配合的。

所以，有一些问题，更喜欢让 AI 自己组一个真正互补的小型专家团，再让他们互相挑战。
...
万能 Prompt，Vibe Coding 的时候也经常用。它最适合处理路径依赖，帮你回归到这个问题的本质。
...
如果你的问题在回到第一性原理之后，感觉都不是很好解决，那不如看看其他行业。说不定另一个行业里，你的这个问题都已经被解决十几年了，也更可能帮你找到那个灵光一闪。

## 四、决策

以上的所有，都是在帮你找到思路，找到解法，帮你找到更多的可能路径和信息量。

但是有时候，你还是会发现，两个答案都有道理，我到底应该选哪一个？这时候，就需要你真的决策了。

### 9. 双向钢人论证

这个 Prompt 详情可看：[一个极度实用的深度思考Prompt，帮你挖出最本质的答案。](https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA==&mid=2647685329&idx=1&sn=9471278dc489641c097b228912965ed4&scene=21#wechat_redirect)

它的底层逻辑是：一个帮你更好地提出问题，一个当你有答案之后不知道选哪个、做决策用的。大家如果有犹豫不决的选择，不妨试试。
...
所以这时候，你其实是需要迈出第一步，去试试，看看现实世界的反馈和数据是什么样子的。那其实，就可以让 AI 给你建议，告诉你如何迈出这一步。
...
这条 Prompt 详情可看：[一个极度实用的Prompt，帮你挖掘出自己的隐藏天赋。](https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA==&mid=2647678138&idx=1&sn=7257d200e639081bce9f2c78e5a0b941&scene=21#wechat_redirect)

它很适合那些还对世界充满期待、希望找到自己的人生天赋的人，也适合那些觉得自己为什么就是没啥天赋、然后怀疑自己的人。

AI 会跟你进行深度的追问和梳理，找到你过去那些看起来毫无关系的经历，然后拼成一份你的个人天赋说明书。这条需要一点耐心，可能动辄半小时以上，不过，回答得越真实、越具体，最后得到的东西就一定越有用。
...
隐藏天赋回答的问题，是“我的身上到底有啥”，它更多是在往过去看。人生设计术继续回答另一个问题：“我接下来还可以往哪去？”它看的，是未来。

详情可看：[我把斯坦福最火的一门课，做成了Prompt来帮我设计人生。](https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA==&mid=2647684133&idx=1&sn=0cdba19fe8e791825e3710d36b6d7c44&scene=21#wechat_redirect)

这套 Prompt 基于斯坦福的人生设计方法，可以很好地帮大家规划未来的人生。
...
这两个 Prompt，交互起来时间都比较长，用的时候，一定要坚持下去。

## 使用建议

1. 全部可以单独复制使用，不需要安装任何 Skill，适配所有主流 AI。
2. 先写真实背景，把【】里的内容换成你自己的信息，越具体越好。
3. 有原始材料（文档、数据等）就尽量一起提供，不怕上下文多。
4. 要求 AI 先提问，而不是自行补齐重要信息；对事实、引用和数据回到一手来源核验。
5. 保存你修改后的版本；稳定复用后可进一步制作成 [Skill](/skills/)。

## 写在最后

可不管 AI 怎么变，Prompt 至今依然是我们使用 AI 的基石。

一个人怎么问问题，怎么判断真假，怎么理解世界，怎么认识自己，这些东西，永远不会过时。人生这道题，只能由你亲自回答。

当 AI 越来越像苍穹上的神明，作为人类，就是站在它们面前，依然知道我们想要什么，想去往何方。而这，大概就是 Prompt 最后的意义。
